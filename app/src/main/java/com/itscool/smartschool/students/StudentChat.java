...
import com.itscool.smartschool.adapters.StudentChatAdapter;
...
public class StudentChat extends BaseActivity implements DatePickerDialog.OnDateSetListener    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.student_chat_activity, null, false);
        mDrawerLayout.addView(contentView, 0);
        titleTV.setText(getApplicationContext().getString(R.string.chat));
...
//     addTaskBtn.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(getApplicationContext(), Constants.primaryColour)));
        ...
        addTaskBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showAddDialog(StudentChat.this);
            }
        });
        adapter = new StudentChatAdapter(StudentChat.this, staff_idList, nameList, imageList);
    ...
    private void showAddDialog(Context context) {
        ...
        final DatePickerDialog datePickerDialog = new DatePickerDialog(context, StudentChat.this, startYear, starthMonth, startDay);
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        String url = Utility.getSharedPreferences(getApplicationContext(), "apiUrl")+Constants.searchuserUrl;
        Log.e("URL", url);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String result) {
                if (result != null) {
                    ...
                    try {
                        ...
                        JSONArray dataArray = object.getJSONArray("chat_user");
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(StudentChat.this, R.string.slowInternetMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(StudentChat.this); //Creating a Request Queue
