...
public class StudentDownloadStudyMaterialFragment extends Fragment {
    ...
    public StudentDownloadStudyMaterialFragment() {
                    ...
                    try {
                        ...
                        if (success.equals("1")) {
                            ...
                            for(int i = 0; i < dataArray.length(); i++) {
                                ...
                                Log.e("asd", dataArray.getJSONObject(i).getString("note"));
